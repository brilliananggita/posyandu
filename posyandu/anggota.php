	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
				    <div class="col-auto">
			            <h1 class="app-page-title mb-0">Anggota</h1>
				    </div>
			    </div><!--//row-->
				...
				<div class="tab-content" id="orders-table-tab-content">
                    ...
                    while ($row = mysqli_fetch_assoc($result)){
                        ...
                        <tr>
                            ...
                            <td class="cell"><?php echo $row['nama_anak']; ?></td>
                            <td class="cell"><?php echo $row['jns_kelamin']; ?></td>
                            <td class="cell"><?php echo $row['tgl_lahir']; ?></td>
                            <td class="cell"><?php echo $row['alamat']; ?></td>
                            <td>
                                <a href="edit_anggota.php?id=<?php echo $row['id']; ?> ">
                                <button class="btn btn-info" name="edit" value="">
                                    Edit
                                </button>
                            </td>
							<td>
                                <a href="delete_anak.php?id=<?php echo $row['id']; ?> ">
