	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
				    <div class="col-auto">
			            <h1 class="app-page-title mb-0">Jadwal Layanan</h1>
				    </div>
			    </div><!--//row-->
				...
				<div class="tab-content" id="orders-table-tab-content">
                    ...
                    $result = mysqli_query($koneksi,"SELECT * from tb_jadwal WHERE status = 'progres'");
                    ...
                    while ($row = mysqli_fetch_assoc($result)){
                        ...
                        <tr>
                            <td class="cell"><?=$i ?></td>
                            <td class="cell"><?php echo $row['pelayanan']; ?></td>
                            <td class="cell"><?php echo $row['tempat']; ?></td>
                            <td class="cell"><?php echo $row['tgl']; ?></td>
                            <td class="cell"><?php echo $row['waktu']; ?></td>
							<td class="cell"><?php echo $row['status']; ?></td>
                            <td>
                                <a href="edit_jadwal.php?id=<?php echo $row['id']; ?> ">
                                <button class="btn btn-info" name="edit" value="">
                                    Edit
                                </button>
                            </td>
							<td>
                                <a href="delete.php?id=<?php echo $row['id']; ?> ">
                                <button class="btn btn-danger" name="delete" value="">
                                    Hapus
                                </button>
                            </td>
                        </tr><?php $i++;
