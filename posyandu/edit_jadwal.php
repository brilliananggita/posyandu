...
include 'koneksi.php';
                        if (isset($_POST['kirim'])) {
                            ...
                            $sql = "UPDATE tb_jadwal SET pelayanan='$pelayanan', tempat='$tempat', tgl='$tgl', waktu='$waktu' WHERE id=$id";
...
$result = mysqli_query($koneksi, "SELECT * FROM tb_jadwal WHERE id='$id'");
						...
						<div class="app-card-body">
							<form class="settings-form" action="" method="POST">
								<div class="mb-3">
									...
									<input name="pelayanan" type="text" class="form-control" id="setting-input-1"  required="" value="<?= $row['pelayanan'] ?>">
								</div>
								<div class="mb-3">
    <label for="setting-input-3" class="form-label">Tempat</label>
    <select class="form-select" name="tempat">
        <option value="Ibu" <?= $row['tempat'] == 'Ibu' ? 'selected' : '' ?>>Posyandu Ibu</option>
        <option value="Telogosari" <?= $row['tempat'] == 'Telogosari' ? 'selected' : '' ?>>Posyandu Telogosari</option>
        <option value="Karangan" <?= $row['tempat'] == 'Karangan' ? 'selected' : '' ?>>Posyandu Karangan</option>
        <option value="Anak" <?= $row['tempat'] == 'Anak' ? 'selected' : '' ?>>Posyandu Anak</option>
    </select>
</div>

								<div class="mb-3">
									<label for="setting-input-2" class="form-label">Tanggal</label>
									<input name="tgl" type="date" class="form-control" id="appt" required="" value="<?= $row['tgl'] ?>"> 
								</div>
								<div class="mb-3">
									<label for="setting-input-2" class="form-label">Waktu</label>
									<input name="waktu" type="time" class="form-control" id="appt" required="" value="<?= $row['waktu'] ?>"> 
								</div>
