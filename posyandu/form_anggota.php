	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
						...
						<div class="app-card-body">
							<form action="" method="POST" class="settings-form">
								<div class="mb-3">
									...
									<input name="id" type="text" class="form-control" id="setting-input-1"  required="" placeholder="Masukan Kode Anggota">
								</div>
								<div class="mb-3">
									<label for="setting-input-2" class="form-label">Nama Anak</label>
									<input name="nama_anak" type="text" class="form-control" id="setting-input-2" required="" placeholder="Masukan Nama Anak">
								</div>
								<div class="mb-3">
									<label for="setting-input-3" class="form-label">Tanggal Lahir</label>
									<input name="tgl_lahir" type="date" class="form-control" id="setting-input-3" placeholder="Masukan Tanggal Lahir">
								</div>
								<div class="mb-3">
									<label for="setting-input-2" class="form-label">Jenis Kelamin</label>
									<div class="form-check mb-2">
										<input type="radio" id="basic-default-radio-male" name="jenis_kelamin" value="laki" class="form-check-input" required=">
										<label class="form-check-label" for="basic-default-radio-male">Laki-laki</label>
									</div>
									<div class="form-check mb-2">
										<input type="radio" id="basic-default-radio-male" name="jenis_kelamin" value="perempuan" class="form-check-input" required="">
										<label class="form-check-label" for="basic-default-radio-male">Perempuan</label>
									</div>
								</div>
								<div class="mb-3">
									<label for="setting-input-2" class="form-label">Alamat</label>
									<input type="text" name="alamat" class="form-control" id="setting-input-2" required="" placeholder="Masukan Alamat">
								</div>
                ...
                if (isset($_POST['kirim'])){
                    ...
                    $alamat = $_POST['alamat'];
                    $sql = "INSERT INTO tb_anggota VALUES ('$id','$nama_anak','$tgl_lahir','$jenis_kelamin','$alamat')";
